...
export default function LoginForm() {
  ...
  const emailStyle: React.CSSProperties = {
    ...baseInputStyle,
    borderColor: focusedField === "email" ? "var(--accent-border)" : undefined,
  };

  const passwordStyle: React.CSSProperties = {
    ...baseInputStyle,
    borderColor: focusedField === "password" ? "var(--accent-border)" : undefined,
  };
    ...
    <div style={wrapperStyle}>
      <div style={cardStyle}>
        ...
        <p style={{ marginTop: "20px", fontSize: "14px", textAlign: "center", color: "var(--text)" }}>
          ¿No tenés cuenta?{" "}
          <button type="button" onClick={() => navigate("/register")} style={linkButtonStyle}>
            Registrate
          </button>
        </p>
